...
@Setter
@JsonPropertyOrder({
        "id", "COD", "NOM", "UD", "GRUP", "PEDIDO", "PROCESO", "BOD31", "BOD32",
        "BOD20", "BOD39", "SMAX", "SMIN", "UNID_OP", "LOTE_OPT", "MODELO",
        "Consumo Promedio", "NEGOCIO", "LINEA", "SUBLINEA", "GRUPO",
        "ca_cla-ni1_id", "ca_cla-ni2_id", "ca_cla-ni3_id", "ca_cla-ni4_id", "ca_cla-ni5_id"
})
public class CoInvNetoSqlDto implements Serializable {
   ...
   /* @JsonProperty("id")
    ...
    @JsonProperty("ca_cla-ni1_id")
    @NotNull
    private Integer ca_cla_ni1_id;

    @JsonProperty("ca_cla-ni2_id")
    @NotNull
    private Integer ca_cla_ni2_id;

    @JsonProperty("ca_cla-ni3_id")
    @NotNull
    private Integer ca_cla_ni3_id;

    @JsonProperty("ca_cla-ni4_id")
    @NotNull
    private Integer ca_cla_ni4_id;

    @JsonProperty("ca_cla-ni5_id")
    @NotNull
