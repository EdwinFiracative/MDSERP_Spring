...
@Entity
@Immutable
@Table(name = "CO_Cartera",  catalog = "EMP001_FACT", schema = "dbo")
public class CoCartera {
    @Id
    @Column(name = "id")
    private Long id;
    ...
    @Column(name = "ABONO", precision = 16, scale = 4)
    private BigDecimal abono;

    @Column(name = "SALDO", precision = 17, scale = 4)
    private BigDecimal saldo;

    @Column(name = "VENCIDA", precision = 17, scale = 4)
